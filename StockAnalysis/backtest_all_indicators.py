...
@tool
def tool_backtest_all_indicators(ticker: str, start_date: datetime, end_date: datetime):
    '''This tool backtests all technical indicators'''
...
def norm_backtest_all_indicators(ticker, start_date, end_date):
    '''This tool backtests all technical indicators'''
    start_date =  str(start_date)
    end_date  = str(end_date)
