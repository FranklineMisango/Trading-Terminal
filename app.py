...
def main():
    ...
    st.sidebar.info('Choose your options below. This application is backed over by 100 mathematically powered algorithms handpicked from the internet and modified for different Trading roles')
    # Create a two-column layout
    left_column, right_column = st.columns([2, 2])

    with left_column:
        option = st.sidebar.radio("Make a choice",('About','Find stocks','Stock Data', 'Stock Analysis','Technical Indicators', 'Stock Predictions'))
        if option =='About':
            about()
