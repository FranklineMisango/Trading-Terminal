...
def main():
    ...
    with left_column:
        ...
        if option =='About':
            st.markdown(
                """
                **Trading Terminal is an Quantitative-powered Application built with Python and Streamlit. It utilizes some aspects of machine learning  to forecast stock prices, carry out analysis and help analysts make data-driven decisions.**

                ## 🏗️ **How It's Built**

                Trading is built with these core frameworks and modules: 
