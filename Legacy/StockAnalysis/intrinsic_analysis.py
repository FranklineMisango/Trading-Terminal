...
@tool
def tool_intrinsic_analysis(ticker:str, start_date:dt.time, end_date:dt.time):
    '''This function retrieves financial data and calculates the intrinsic value of a stock.'''
...
def norm_intrinsic_analysis(ticker:str, start_date:dt.time, end_date:dt.time):
    pd.set_option('float_format', '{:f}'.format)
