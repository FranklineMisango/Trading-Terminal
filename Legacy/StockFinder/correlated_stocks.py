...
@tool
def tool_correlated_stocks(tool_start_date : dt.date, tool_end_date : dt.date, sector : str):
    ...
    sectors = {
                    ...
                    "Consumer ": ['AMZN', 'TSLA', 'HD', 'MCD', 'DIS', 'NKE', 'SBUX', 'BKNG', 'LOW', 'CMG'],
                    "Communication ": ['GOOGL', 'META', 'DIS', 'CMCSA', 'NFLX', 'T', 'CHTR', 'DISCA', 'FOXA', 'VZ'],
