...
@tool
def tool_miniverini_screener(start_date : dt.date, end_date : dt.date):
    '''This tool allows you to find stocks that meet Minervini's criteria'''
...
def minervini_screener(start_date, end_date):
    tickers = ti.tickers_sp500()
    tickers = [ticker.replace(".", "-") for ticker in tickers]
    index_name = '^GSPC'
    start_date = start_date
